...
<head>
    ...
    <title>Dashboard Bank Sampah — EcoPalu</title>
...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">Dashboard Bank Sampah (Kabelotapura)</small>
        </div>
    ...
    <div class="card shadow-sm" style="border-radius:16px;">
        <div class="card-body p-4">
            <h4 class="mb-3">Dashboard Bank Sampah — Coming Soon</h4>
            ...
            <p class="text-muted mb-0">
                Halaman dashboard Bank Sampah sesuai spec CLAUDE.md (Daftar penjemputan dengan tombol Konfirmasi Selesai, Kalender, dll) akan dibangun di langkah selanjutnya.
            </p>
        </div>
    </div>
